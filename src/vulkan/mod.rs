...
pub struct Entry {
    instance: NonZeroU64,
    #[cfg(unix)]
    pub(super) get_instance_proc_addr: libloading::os::unix::Symbol<vk::FnGetInstanceProcAddr>,
    #[cfg(windows)]
    pub(super) get_instance_proc_addr: libloading::os::windows::Symbol<vk::FnGetInstanceProcAddr>,
    pub(super) create_instance: vk::FnCreateInstance,
    pub(super) destroy_instance: vk::FnDestroyInstance,
    pub(super) enumerate_physical_devices: vk::FnEnumeratePhysicalDevices,
    pub(super) get_physical_device_properties: vk::FnGetPhysicalDeviceProperties
}
